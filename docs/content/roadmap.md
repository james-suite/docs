...
id: roadmap
title: Roadmap
description: Módulos ativos, planejados e limites conhecidos do James.
type: planning
status: proposed
visibility: public
tags: roadmap, planejamento, produto
related: home, funcionalidades, contribuicao
source_refs: https://github.com/james-suite/james/blob/master/README.md
---

Visão geral dos módulos desenvolvidos e planejados para o James.
...
- **Calendário & Agenda**: Centralização de eventos, compromissos e lembretes, com integração progressiva aos demais módulos.
...
- **Patrimônio**: Cadastro e acompanhamento de bens e evolução patrimonial.
